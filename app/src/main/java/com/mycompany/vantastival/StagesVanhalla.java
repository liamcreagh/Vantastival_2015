...
public class StagesVanhalla extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new VanhallaFragmentPagerAdapter(getSupportFragmentManager(), StagesVanhalla.this));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_stages_vanhalla, menu);
        return true;
    }
