...
public class PopupInfo extends Activity implements OnClickListener {
    ...
    public void init() {
        ...
        popupText.setPadding(0, 0, 0, 20); layoutOfPopup.setOrientation(1);
        layoutOfPopup.addView(popupText); layoutOfPopup.addView(insidePopupButton); }
